...
#
# SuperBob is the IBM Bob extension that packages a skills library for use in
...
# lifted into its own git repo later with no code changes: set SB_LIBRARY to the path of a skills-library
# checkout and everything else keeps working.
...
# The skills library this extension packages. Override by exporting SB_LIBRARY.
