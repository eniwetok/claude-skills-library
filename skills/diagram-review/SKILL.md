---
name: diagram-review
description: Review architecture diagrams and flowcharts for professional quality — readability, layout, hierarchy, and edge crossings — then recommend concrete fixes. Use after generating a diagram with any tool (draw.io, mermaid, excalidraw) to make it clean and professional, or when someone asks to critique or improve a diagram.
license: MIT
---
